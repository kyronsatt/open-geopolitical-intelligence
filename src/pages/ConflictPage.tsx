...
const ConflictPage = () => {
  ...
  const [snapshotHistory, setSnapshotHistory] = useState<
    Pick<AnalysisSnapshot, "id" | "created_at" | "triggered_by_event_id">[]
  >([]);
    ...
    <div className="min-h-screen bg-base">
      ...
      <div className="pt-20 max-w-6xl mx-auto px-4 md:px-8 space-y-16">
        ...
        <div id="section-Briefing">
          <BriefingPanel snapshot={snapshot} actors={conflict.actors} />
        </div>
        ...
        <div id="section-Impact">
          <ImpactMetrics snapshot={snapshot} actors={conflict.actors} />
        </div>
